...
CREATE TABLE ImageDB.Command (
	CommandID INT IDENTITY(1,1) NOT NULL PRIMARY KEY,
	Command NVARCHAR(255) NOT NULL,
	UUID UNIQUEIDENTIFIER NOT NULL DEFAULT NEWID()
);

SET IDENTITY_INSERT ImageDB.Command ON

INSERT INTO ImageDB.Command (CommandID, Command, UUID)
VALUES
	(1,	'CREATE',	'15A68254-9E33-4C9B-8250-76797FA322D8'),
	(2,	'READ',		'17A20163-FCB6-4429-841A-6C6378420F98'),
	(3,	'UPDATE',	'724BEB0B-55B1-4C40-A9EE-E7600E2C8B06'),
	(4,	'DELETE',	'AFDAFA04-CAB1-4CB6-9763-7A017A6A692B'),
	(5,	'NULL',		'111745FF-5213-489D-81CD-D50C45C3C2FE'),
	(6,	'EXECUTE',	'D291CF58-92F1-43F5-BDEF-3E15B19E5B6C');


SET IDENTITY_INSERT ImageDB.Command OFF
GO